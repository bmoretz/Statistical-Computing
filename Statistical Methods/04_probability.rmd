...
If X has a standard normal distribution with, determine:
...
Assuming that the scores on a math achievement test are normally distributed with $\mu = 69$ and standard deviation $\sigma = 10$, what is the probability of getting a score greater than 78?
...
Determien the probability that a randomly selected battery will last at least 62 months.
